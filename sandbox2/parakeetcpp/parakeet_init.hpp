...
using ParakeetContextParameters        = struct parakeet_context_params;
using ParakeetFullContextParameters    = struct parakeet_full_params;
using ParakeetContext                  = struct parakeet_context;
using ParakeetContextHandle            = ParakeetContext*;
...
{
    static constexpr u32 kInferenceSampleRate = PARAKEET_SAMPLE_RATE;
