...
struct ProgramContext 
{
    ...
    SherpaOnnxFullContextParametersHandle mh_llmFullParams;
    SherpaOnnxContextParametersHandle     mh_modelParams;
    SherpaOnnxContextHandle               mh_llmContext;
    SherpaOnnxStreamHandle                mh_inferenceStream;
    SherpaOnnxInferenceResultHandle       mh_inferenceResult;
};
